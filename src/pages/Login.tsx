              ...
              <Tabs defaultValue="email" className="mb-6" onValueChange={(value) => setLoginMethod(value as 'email' | 'phone')}>
                ...
                <TabsContent value="email">
                  <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="password-email" className="text-gray-700">Password</Label>
                      <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <TabsContent value="phone">
                  <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="password-phone" className="text-gray-700">Password</Label>
                      <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                          <Lock className="h-5 w-5 text-gray-400" />
                        </div>
